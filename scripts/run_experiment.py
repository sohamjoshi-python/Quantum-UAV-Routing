...
# IMPORTANT:
# Replace this import if your current trip-builder module has a different filename.
from quantum_uav_routing.rtv.trip_builder import build_trips

# IMPORTANT:
# Replace this import if your current travel function lives elsewhere.
from quantum_uav_routing.rtv.travel import travel
